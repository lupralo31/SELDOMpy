...
res = optimization(model=model, exps=exps, ivpsol=ivpsol, epoch=1500, pop_size=50, miu_f=0.3, miu_cr=0.6)
...
file_name = f"results/MAPK_opt_REALK_{REALK}_NBINS_{NBINS}_SEED_{initial_seed}.pkl"
...
for i in range(len(edges)):
    ...
    opt = optimization(model=model, exps=exps, ivpsol=ivpsol, epoch=1500, pop_size=50, miu_f=0.3, miu_cr=0.6)
...
file_name = f"results_reduced_AIC/MAPK_opt_REALK_{REALK}_NBINS_{NBINS}_SEED_{initial_seed}.pkl"
