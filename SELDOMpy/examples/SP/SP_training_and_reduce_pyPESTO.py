...
if __name__ == '__main__':
    ...
    file_name = f"results/SP_opt_REALK_{REALK}_NBINS_{NBINS}_SEED_{initial_seed}_pyPESTO.pkl"
...
if __name__ == '__main__':
    ...
    file_name = f"results_reduced_AIC/SP_opt_REALK_{REALK}_NBINS_{NBINS}_SEED_{initial_seed}_pyPESTO.pkl"
